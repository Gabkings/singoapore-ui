...
import './vouchers-search.css';
import ButtonWrapper from '../../components/Base/Button';

/* eslint-disable react/prefer-stateless-function */
export default class VouchersSearch extends React.PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <Card className="vouchers-search">
        <Card.Content>
          <Form
            onSubmit={() => {
              onApplyFilter({
          ...
          >
            <Grid padded className="vouchers-search-grid">
              <Grid.Row>
                <Grid.Column mobile={16} computer={8}>
                  <Input
                    type="text"
                    className="vouchers-search-input"
