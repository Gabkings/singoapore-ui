    ...
    return (
      <TemplatePage {...this.props}>
        ...
        >
          ...
          <h2>Version 1.0</h2>
          <p>
            This website located at http://sghomeneeds.com is owned and operate
            by Leading Solution Pte Ltd (UEN 201531216Z), a company incorporated
            in the Republic of Singapore (&ldquo;Sg Home Needs&rdquo;,
            &ldquo;we&rdquo; or &ldquo;us&rdquo;). Certain features of the Site
          ...
          <p>
            Like any other website, uses &lsquo;cookies&rsquo;. These cookies
            are used to store information including visitors&rsquo; preferences,
            and the pages on the website that the visitor accessed or visited.
            The information is used to optimize the users&rsquo; experience by
            customizing our web page content based on visitors&rsquo; browser
          ...
          <p>
            ...
            their website. For easier access, an updated and hyperlinked
          ...
          <ul>
            <li>
              <strong>Account Creation. </strong>For you to use the Site, you
              have to start an account and provide information about yourself.
              You warrant that: (a) all required registration information you
              submit is truthful, up-to-date and accurate; (b) you will maintain
              the accuracy of such information. You may delete your Account at
              any time by following the instructions on the Site.&nbsp; Company
          ...
          <ol>
            <li>
              <ul>
                <li>
                  <strong>Account Responsibilities.</strong> You are responsible
                  for maintaining the confidentiality of your Account login
                  information and are fully responsible for all activities that
                  occur under your Account. You approve to immediately notify
                  the Company of any unauthorized use, or suspected unauthorized
                  use of your Account.&nbsp; Company cannot and will not be
          ...
          <ul>
            ...
            <li>
              ...
              content are owned by Company or Company&rsquo;s suppliers. Note
              that these Terms and access to the Site do not give you any
              rights, title or interest in or to any intellectual property
              rights, except for the limited access rights expressed in Section
          ...
          <ul>
            <li>
              <strong>User Content.</strong> &ldquo;<strong>
                User Content
              </strong>&rdquo; means any and all information and content that a
              ...
              violate our Acceptable Use Policy.&nbsp; You may not represent or
              ...
              you post; also, your User Content may be deleted at any time
            ...
            <li>
              ...
              constitute our &ldquo;<strong>Acceptable Use Policy</strong>&rdquo;:
            </li>
            <li>
              ...
              threatening, harmful, invasive of another&rsquo;s privacy, vulgar,
            ...
            <li>
              ...
              interfere with any other user&rsquo;s use and enjoyment of the
              Site; or (vi) use software or automated agents or scripts to
              produce multiple accounts on the Site, or to generate automated
          ...
          <p>
            4. You agree to indemnify and hold Company and its officers,
            employees, and agents harmless, including costs and attorneys&rsquo;
          ...
          <p>
            ...
            available&rdquo; basis, and company and our suppliers expressly
            ...
            title, quiet enjoyment, accuracy, or non-infringement.&nbsp; We and
          ...
          <p>
            <strong>7.1 Term and Termination. </strong>Subject to this Section,
          ...
          <p>
            <strong>7.2 Copyright Policy.</strong>
          </p>
          <p>
            ...
            in the form of a written notification (pursuant to 17 U.S.C. &sect;
          ...
          <p>
            Please note that, pursuant to 17 U.S.C. &sect; 512(f), any
            ...
            damages, costs and attorney&rsquo;s fees incurred by us in
          ...
          <ul>
            ...
            <li>
              ...
              <em>
                <strong>
                  ...
                  It contains procedures for MANDATORY BINDING ARBITRATION AND A
                  CLASS ACTION WAIVER.
                </strong>
              </em>
              <ul>
                <li>
                  <em>Applicability of Arbitration Agreement.</em> All claims
                  and disputes in connection with the Terms or the use of any
                ...
                <li>
                  ...
                  to: 51 Goldhill Plaza,#08-02, 308900, Singapore. After the
                  Notice is received, you and the Company may attempt to resolve
                  the claim or dispute informally.&nbsp; If you and the Company
                ...
                <li>
                  ...
                  ADR Provider.&nbsp; The rules of the ADR Provider shall govern
                  all aspects of the arbitration except to the extent such rules
                  are in conflict with the Terms.&nbsp; The AAA Consumer
                  ...
                  date, time and place of any oral hearings. Any judgment on the
                  award rendered by the arbitrator may be entered in any court
                  of competent jurisdiction.&nbsp; If the arbitrator grants you
                  an award that is greater than the last settlement offer that
                  the Company made to you prior to the initiation of
                ...
                <li>
                  <em>Time Limits.</em> If you or the Company pursues
                ...
                <li>
                  <em>Authority of Arbitrator</em>. If arbitration is initiated,
                  ...
                  available to an individual under applicable law, the AAA
                  Rules, and the Terms.&nbsp; The arbitrator shall issue a
                ...
                <li>
                  <em>Waiver of Jury Trial.</em> THE PARTIES HEREBY WAIVE THEIR
                  ...
                  arise between you and the Company in any state or federal
                ...
                <li>
                  <em>Waiver of Class or Consolidated Actions</em>. All claims
                  and disputes within the scope of this arbitration agreement
                  must be arbitrated or litigated on an individual basis and not
                  on a class basis, and claims of more than one customer or user
                  cannot be arbitrated or litigated jointly or consolidated with
                  those of any other customer or user.
                </li>
                <li>
                  <em>Confidentiality</em>. All aspects of the arbitration
                ...
                <li>
                  <em>Severability</em>. If any part or parts of this
                ...
                <li>
                  <em>Right to Waive.</em> Any or all of the rights and
                ...
                <li>
                  <em>Survival of Agreement</em>. This Arbitration Agreement
                  will survive the termination of your relationship with
                  Company.
                </li>
                <li>
                  <em>Small Claims Court.</em> Nonetheless the foregoing, either
                  you or the Company may bring an individual action in small
                  claims court.
                </li>
                <li>
                  <em>Emergency Equitable Relief</em>. Anyhow the foregoing,
                  either party may seek emergency equitable relief before a
                  state or federal court in order to maintain the status quo
                  pending arbitration.&nbsp; A request for interim measures
                  shall not be deemed a waiver of any other rights or
                  obligations under this Arbitration Agreement.
                </li>
                <li>
                  <em>Claims Not Subject to Arbitration. </em>Notwithstanding
                  the foregoing, claims of defamation, violation of the Computer
                  Fraud and Abuse Act, and infringement or misappropriation of
                  the other party&rsquo;s patent, copyright, trademark or trade
            ...
            <li>
              ...
              limitation&rdquo;. If any provision of these Terms is held to be
              ...
              extent permitted by law.&nbsp; Your relationship to Company is
              ...
              or otherwise transferred by you without Company&rsquo;s prior
              ...
              and void.&nbsp; Company may freely assign these Terms.&nbsp; The
              terms and conditions set forth in these Terms shall be binding
              upon assignees.
            </li>
            <li>
              <strong>Copyright/Trademark Information</strong>. Copyright &copy;
              2017. All rights reserved.&nbsp; All trademarks, logos and service
            ...
            <li>
              ...
              <ul>
                ...
                <li>Telephone: +65 31591485</li>
                <li>Email: support@sghomeneeds.com</li>
              </ul>
            </li>
          </ul>
        </Subsection>
