...
export default class ProfessionalsInfoCardForProfessionals extends React.PureComponent {
  static propTypes = {
            ...
            <Grid style={{margin: '5px 0px 0px 5px'}} columns={2}>
              <Grid.Row>
                ...
                <Grid.Column mobile={16}>
                  <Dropdown style={{minWidth: '20rem'}} placeholder='Select Service' search selection options={categoryOptions} onChange={this.handleOnCategoryDropdownChange}/>
                </Grid.Column>
              </Grid.Row>
            </Grid>
          }
  ...
  render() {
    ...
    return (
      <Card>
        {<Modal closeOnDimmerClick={false} open={this.state.showCategoryModal} onClose={this.closeCategoryModal} closeIcon={{ style: { top: '0.05rem', right: '1rem' }, color: 'black', name: 'close' }} >
          <div>
